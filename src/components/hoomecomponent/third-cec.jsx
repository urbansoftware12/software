    ...
    return(
        <div className="thrdcec">
            <div className="container-fluid" style={{paddingTop: '50px', paddingBottom: '60px',maxWidth:'1280px'}}>
                ...
                <div className="row">
                    <div className="col-lg-3 col-md-3 skil skilo1">
                    ...
                    <div className="col-lg-3 col-md-3 skil skilo2">
                        <div className="text-center" style={{marginBottom: '20px'}}>
                    ...
                    <div className="col-lg-3 col-md-3 skil skilo3">
                        <div className="text-center" style={{marginBottom: '20px'}}>
                    ...
                    <div className="col-lg-3 col-md-3 skil skilo4">
                        <div className="text-center" style={{marginBottom: '20px'}}>
                ...
                <div className="row">
                <div className="col-lg-3 col-md-3 skil skilo">
                        <div className="text-center" style={{marginBottom: '20px'}}>
                    ...
                    <div className="col-lg-3 col-md-3 skil skilo5">
                        <div className="text-center" style={{marginBottom: '20px'}}>
                    ...
                    <div className="col-lg-3 col-md-3 skil skilo6">
                        <div className="text-center" style={{marginBottom: '20px'}}>
                    ...
                    <div className="col-lg-3 col-md-3 skil skilo7">
                        <div className="text-center" style={{marginBottom: '20px'}}>
