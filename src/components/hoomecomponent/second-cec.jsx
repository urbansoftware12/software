            ...
            <div className="container-fluid pixo" style={{maxWidth:'1280px'}}>
                ...
                <div className="row">
                    ...
                    <div className="offset-lg-1 col-lg-6 offset-md-1 col-md-6">
                        ...
                        <div>
                            <p className="pfulll" style={{color: 'rgba(0, 0, 0, 0.64)'}}>Here’s how our journey has built the solid foundation we have today of helping so many businesses succeed.</p>
                        </div>
