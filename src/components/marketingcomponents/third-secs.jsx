                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6">
                        <div>
                            ...
                            <div style={{paddingTop: '3%', paddingBottom: '3%'}}>
                                <button className="btn" style={{fontFamily: 'Urbanist',borderRadius: '3px', paddingTop: '2.5%', paddingBottom: '2.5%', paddingLeft: '5%', paddingRight: "5%", backgroundColor: '#65E4A1'}}>Get a Free Consultation</button>
                            </div>
                        </div>
                    </div>
