        ...
        <div className="forscc">
            <div className="container-fluid" style={{color: 'black'}}>
                <div style={{paddingTop:'80px',paddingBottom:'80px'}}>
                    ...
                    <div className="" style={{display: 'flex', justifyContent: 'space-around', alignItems: 'baseline', flexWrap: 'wrap'}}>
                ...
                {/* mobile */}
                <div className="d-none" style={{display: 'flex', justifyContent: 'space-around', alignItems: 'center', flexWrap:'wrap'}}>
                    ...
                    <div style={{paddingTop:'20px',width:'50%'}}>
